...
jobs = [
    'python learn_bp_map_marginal_spinglass.py --data_map_flag %s %s %s %s %s %s -lr %f --alpha %f --layer_num %d'%(
        dflag, aflag, mflag, cflag, sflag, bflag,
...
for i in range(PROCESS_NUM):
    fname = 'bpnn_sum_marginal_jobs_%d.sh'%i
