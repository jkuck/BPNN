...
MRFTOOLS_LBP_ITERS = 10000 #iterations of loopy belief propagation to run in mrftools
LIBDAI_LBP_ITERS = 10000 #iterations of loopy belief propagation to run in libdai
LIBDAI_MEAN_FIELD_ITERS = 10000 #iterations of mean field to run in libdai
