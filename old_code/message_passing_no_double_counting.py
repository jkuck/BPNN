...
class MessagePassing_NoDoubleCounting(torch.nn.Module):
    ...
    def propagate(self, edge_index, size=None, **kwargs):
        ...
        print("self.__message_args__", self.__message_args__)
        print("self.__special_args__", self.__special_args__)
        ...
        # print("message_args", message_args)
        # sleep(message_args)
